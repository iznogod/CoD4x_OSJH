...
__cdecl void Com_ShutdownDObj();
__cdecl void DObjShutdown();
__cdecl void XAnimShutdown();
__cdecl void Com_ShutdownWorld();
__cdecl void CM_Shutdown();
__cdecl void Hunk_Clear();
